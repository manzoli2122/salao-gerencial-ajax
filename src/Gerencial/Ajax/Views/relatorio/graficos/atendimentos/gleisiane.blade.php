<script>  
  ...
  $(function () {
    ...
    dados_diario_atendimento_gringa.push([ {{ Manzoli2122\Salao\Atendimento\Ajax\Models\AtendimentoFuncionario::whereDate('created_at', $data->format('Y-m-d') )->where('funcionario_id', 5)->sum('valor') }}   ])
    <?php $data->subDays($i); ?>
  @endfor
