<script>  
  $(function () {
    ...
    dados_diario_pagamento_credito.push([ {{ Manzoli2122\Salao\Atendimento\Ajax\Models\Pagamento::whereDate('created_at', $data->format('Y-m-d') )->where('formaPagamento', 'credito')->sum('valor') }}   ])
    <?php $data->subDays($i); ?>
  @endfor
