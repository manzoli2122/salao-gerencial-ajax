<script>  
  $(function () {
    ...
    @for ($i = 0 ; $i < $dia ; $i++ )
      ...
      dados_diario_pagamento_debito.push([ {{ Manzoli2122\Salao\Atendimento\Ajax\Models\Pagamento::whereDate('created_at', $data->format('Y-m-d') )->where('formaPagamento', 'debito')->sum('valor') }}   ])
      <?php $data->subDays($i); ?>
    @endfor
